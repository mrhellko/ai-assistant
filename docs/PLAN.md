...
- [ ] Добавить кавычки вокруг `reminder_text` в подтверждении, например `Готово. Напомню "сводить ребенка в поликлинику" в 16:26`.
- [ ] Добавить постраничный просмотр будущих напоминаний пользователя.
- [ ] Добавить удаление будущих напоминаний из списка.
